...
public class Camera{
    ...
    public void draw(Program prog){
        //prog.setUniform("lightPos", add(eye.xyz(), mul(1.1, W.xyz())));
        prog.setUniform("lightPos", new vec3(25,25,25));
    ...
    public vec4 rotate(vec4 coi, float a){
        strafe(U.xz(), a);
        lookAt(eye.xyz(), coi.xyz(), Y_AXIS.xyz());
        //System.out.println("Cam W: " + this.W);
        return normalize(W);
    }
        
    public void strafe( vec2 v, float a){
        vec2 dir = v.mul(a);
        eye = add( eye , new vec4(dir.x, 0, dir.y, 0));
        compute_view_matrix();
    }
